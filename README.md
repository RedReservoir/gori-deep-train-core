...
A Python package containing many basic primitives used to build pipelines for the [`gori-deep-train`](https://github.com/RedReservoir/gori-deep-train) project. You can read further detailed documentation [here](https://gori-deep-train-core.readthedocs.io/en/latest/).
